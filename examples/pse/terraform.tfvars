...
#####################################################################################################################
##### Custom BYO variables. Only applicable for "pse" deployment without "base" resource requirements  #####
#####################################################################################################################
...
## 20. Provide your existing Service Edge subnet names. Only uncomment and modify if you set byo_subnets to true
...
##     Gateway resources associated with the PSE subnets mapped to the same respective zones.
##
##     Example: byo_subnet_names = ["subnet-az1","subnet-az2"]

#byo_subnet_names                           = ["existing-pse-subnet"]

## 21. By default, this script will create new Public IP resources to be associated with PSE NAT Gateways.
...
## 24. By default, this script will create new NAT Gateway resources for the Service Edge subnets to be associated
...
##      Uncomment if you are deploying Service Edge to an environment where the PIP already exists AND is already asssociated to
...
## 28.  By default this script will create a new Azure NAT Gateway and associate it with new or existing PSE subnets.
##      Uncomment if you are deploying Service Edge to an environment where the subnet already exists AND is already asssociated to
##      an existing NAT Gateway. (true or false. Default: false).
...
## 29. By default, this script will create new Network Security Groups for the Service Edge interfaces

################################################################################
# Retrieve the "Service Edge" enrollment certificate used for OAuth2 enrollment.
# This module exclusively onboards Private Service Edges, so the certificate
# name is intentionally hardcoded and not exposed as a variable.
################################################################################

# Zscaler ZPA Provider Private Service Edge Provisioning Key Module

This module provides the resources necessary to create a new ZPA Private Service Edge Provisioning Key to be used with Private Service Edge appliance deployment and provisioining.
...
| <a name="input_byo_provisioning_key_name"></a> [byo\_provisioning\_key\_name](#input\_byo\_provisioning\_key\_name) | Existing Private Service Edge Provisioning Key name | `string` | `null` | no |
...
| <a name="input_provisioning_key_max_usage"></a> [provisioning\_key\_max\_usage](#input\_provisioning\_key\_max\_usage) | The maximum number of instances where this provisioning key can be used for enrolling a Private Service Edge | `number` | n/a | yes |

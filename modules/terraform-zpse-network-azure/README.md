# Zscaler Private Service Edge / Azure Network Infrastructure Module
...
| [azurerm_subnet.pse_subnet](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/subnet) | resource |
| [azurerm_subnet_nat_gateway_association.pse_subnet_nat_association](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/subnet_nat_gateway_association) | resource |
...
| [azurerm_subnet.pse_subnet_selected](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/data-sources/subnet) | data source |
...
| <a name="input_byo_subnets"></a> [byo\_subnets](#input\_byo\_subnets) | Bring your own Azure subnets for Private Service Edge. If false, new subnet(s) will be created automatically. Default 1 subnet for Private Service Edge if 1 or no zones specified. Otherwise, number of subnes created will equal number of Private Service Edge zones | `bool` | `false` | no |
| <a name="input_byo_vnet"></a> [byo\_vnet](#input\_byo\_vnet) | Bring your own Azure VNet for Private Service Edge. If false, a new VNet will be created automatically | `bool` | `false` | no |
...
| <a name="input_network_address_space"></a> [network\_address\_space](#input\_network\_address\_space) | VNet IP CIDR Range. All subnet resources that might get created (public, service edge) are derived from this /16 CIDR. If you require creating a VNet smaller than /16, you may need to explicitly define all other subnets via public\_subnets and pse\_subnets, variables | `string` | `"10.1.0.0/16"` | no |
